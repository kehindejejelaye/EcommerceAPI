...
{
    [Route("api/users/{userId}/shoppingcartitems")]
    [ApiController]
    public class ShoppingCartItemsController : ControllerBase
    {
        ...
        public ShoppingCartItemsController(IRepositoryManager repoManager, IMapper mapper, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<IActionResult> GetShoppingCartItems(string userId)
        {
            ...
            var cartItems = _repoManager.ShoppingCartItem.GetShoppingCartItems(userId);
