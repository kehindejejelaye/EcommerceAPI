...
public class ProductItemsController : ControllerBase
{
    ...
    [HttpGet("search")]
    public async Task<ActionResult<IEnumerable<ReadProductItemDto>>> SearchProductItems([FromQuery] RequestParameters requestParameters)
    {
        var productItems = await _repoManager.ProductItem.SearchProductItems(requestParameters);
        var productItemDtos = _mapper.Map<IEnumerable<ReadProductItemDto>>(productItems);
