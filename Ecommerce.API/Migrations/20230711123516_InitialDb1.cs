...
namespace Ecommerce.API.Migrations
{
    public partial class InitialDb1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favorites_ProductItems_ProductItemId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductItemVariantOptions",
                columns: table => new
                {
                    ProductItemId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductItemVariantOptions", x => new { x.ProductItemId, x.VariantOptionId });
                    table.ForeignKey(
                        name: "FK_ProductItemVariantOptions_ProductItems_ProductItemId",
                        column: x => x.ProductItemId,
                        principalTable: "ProductItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductItemVariantOptions_VariantOptions_VariantOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_ProductItemId",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItemVariantOptions_VariantOptionId",
